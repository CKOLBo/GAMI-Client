    ...
    <div className="relative 2xl:w-[468px] 2xl:h-[228px] w-[360px] h-[180px] 2xl:rounded-[18px] rounded-[16px] bg-white p-3 shadow-GAMI">
      <div className="flex items-start gap-5 h-full">
        ...
        <div className="flex flex-col justify-start pt-8">
          {isEmpty ? (
            <div className="h-[24px] w-32 bg-gray-4 rounded mb-3 animate-pulse"></div>
          ) : (
          ...
          <div className="flex gap-2">
            {isEmpty ? (
              <>
                <div className="rounded-md px-3 py-0.3 bg-gray-4 h-[28px] w-16 animate-pulse"></div>
                <div className="rounded-md px-3 py-0.3 bg-gray-4 h-[28px] w-24 animate-pulse"></div>
              </>
            ) : (
              <>
