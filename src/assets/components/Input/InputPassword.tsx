  ...
  return (
    <div className="relative">
      <input
        ...
        onChange={onChange}
        required
        className="w-full h-15 px-5 pr-14 border placeholder:font-medium border-[#B7BCC8] rounded-xl text-sm text-[#3D3D48] placeholder:text-[#6D6F79] focus:outline-none focus:border-[#73A9FF]"
      />
      <button
        type="button"
